...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/prebuilt/usr/keylayout/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl \
    $(LOCAL_PATH)/prebuilt/usr/keylayout/qwerty.kl:system/usr/keylayout/qwerty.kl \
    $(LOCAL_PATH)/prebuilt/usr/keylayout/Vendor_0079_Product_0011.kl:system/usr/keylayout/Vendor_0079_Product_0011.kl
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media_codecs_vivo_audio.xml:system/etc/media_codecs_vivo_audio.xml \
    $(LOCAL_PATH)/configs/media_codecs_vivo_video.xml:system/etc/media_codecs_vivo_video.xml \
    $(LOCAL_PATH)/configs/vilte/viLTE_media_profiles_OP01.xml:system/etc/vilte/vilteviLTE_media_profiles_OP01.xml \
    $(LOCAL_PATH)/configs/vilte/viLTE_media_profiles_OP01.xml:system/etc/vilte/viLTE_media_profiles_OP12.xml \
